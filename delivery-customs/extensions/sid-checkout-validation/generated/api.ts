...
export type BuyerJourney = {
  ...
  step?: Maybe<BuyerJourneyStep>;
};

/** Different steps in the buyer journey. */
export enum BuyerJourneyStep {
  /** Buyer is interacting with the cart. */
  CartInteraction = 'CART_INTERACTION',
  /** Buyer is completing the checkout. */
  CheckoutCompletion = 'CHECKOUT_COMPLETION',
  /** Buyer is interacting with the checkout. */
  CheckoutInteraction = 'CHECKOUT_INTERACTION'
}
...
export type FunctionError = {
  ...
  localizedMessage: Scalars['String'];
...
export type InputQuery = { __typename?: 'Input', cart: { __typename?: 'Cart', buyerIdentity?: { __typename?: 'BuyerIdentity', customer?: { __typename?: 'Customer', numberOfOrders: number } | null } | null, cost: { __typename?: 'CartCost', subtotalAmount: { __typename?: 'MoneyV2', amount: any } } } };

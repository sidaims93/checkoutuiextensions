...
export type DeliveryCustomization = HasMetafields & {
...
export type Input = {
  ...
  /** The cart. */
  cart: Cart;
  /** The delivery customization that owns the current function. */
...
/** Request to move a delivery option to a new index. */
...
export type Operation =
  ...
  |  /** Request to rename a delivery option. */
...
export type InputQuery = { __typename?: 'Input', cart: { __typename?: 'Cart', deliveryGroups: Array<{ __typename?: 'CartDeliveryGroup', deliveryAddress?: { __typename?: 'MailingAddress', provinceCode?: string | null } | null, deliveryOptions: Array<{ __typename?: 'CartDeliveryOption', handle: string, title?: string | null }> }> }, deliveryCustomization: { __typename?: 'DeliveryCustomization', metafield?: { __typename?: 'Metafield', value: string } | null } };

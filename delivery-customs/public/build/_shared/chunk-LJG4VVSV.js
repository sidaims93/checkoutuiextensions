...
function sanitizeCustomProperties(styles40) {
  const nonNullValues = Object.entries(styles40).filter(([_17, value]) => value != null);
...
function useDisableClick(disabled, handleClick) {
  const handleClickWrapper = (0, import_react45.useCallback)((event) => {
    if (disabled) {
...
function Portal({
  ...
  return container ? /* @__PURE__ */ (0, import_react_dom.createPortal)(/* @__PURE__ */ import_react48.default.createElement("div", {
...
function wrapWithComponent(element, Component2, props) {
  ...
  return isElementOfType(element, Component2) ? element : /* @__PURE__ */ import_react49.default.createElement(Component2, props, element);
}
...
function isElementOfType(element, Component2) {
  if (element == null || !/* @__PURE__ */ (0, import_react49.isValidElement)(element) || typeof element.type === "string") {
    return false;
  }
  const {
    type: defaultType
...
function elementChildren(children, predicate = () => true) {
  return import_react49.Children.toArray(children).filter((child) => /* @__PURE__ */ (0, import_react49.isValidElement)(child) && predicate(child));
}
...
function KeypressListener({
  ...
  const tracked = (0, import_react50.useRef)({
    handler,
    keyCode
  });
  useIsomorphicLayoutEffect(() => {
  ...
  const handleKeyEvent = (0, import_react50.useCallback)((event) => {
    const {
      handler: handler2,
      keyCode: keyCode2
    } = tracked.current;
...
function useFeatures() {
  const features = (0, import_react57.useContext)(FeaturesContext);
  if (!features) {
...
function Pane({
  ...
  return fixed ? /* @__PURE__ */ import_react59.default.createElement("div", {
    style,
    className
  }, content) : /* @__PURE__ */ import_react59.default.createElement(Scrollable, {
    shadow: true,
    className,
    style,
    onScrolledToBottom
...
var PopoverOverlay = class extends import_react60.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      transitionStatus: this.props.active ? TransitionStatus.Entering : TransitionStatus.Exited
    };
    this.contentNode = /* @__PURE__ */ (0, import_react60.createRef)();
    this.renderPopover = (overlayDetails) => {
      ...
      return /* @__PURE__ */ import_react60.default.createElement("div", Object.assign({
        className
      }, overlay.props), /* @__PURE__ */ import_react60.default.createElement(EventListener, {
        event: "click",
        handler: this.handleClick
      }), /* @__PURE__ */ import_react60.default.createElement(EventListener, {
        event: "touchstart",
        handler: this.handleClick
      }), /* @__PURE__ */ import_react60.default.createElement(KeypressListener, {
        keyCode: Key.Escape,
    ...
    this.overlayRef = /* @__PURE__ */ (0, import_react60.createRef)();
  }
  forceUpdatePosition() {
  ...
  render() {
    ...
    return /* @__PURE__ */ import_react60.default.createElement(PositionedOverlay, {
      ref: this.overlayRef,
      fullWidth,
      active,
      activator,
...
// node_modules/@shopify/polaris/build/esm/components/Popover/Popover.js
var PopoverComponent = /* @__PURE__ */ (0, import_react61.forwardRef)(function Popover({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react61.useState)();
  const overlayRef = (0, import_react61.useRef)(null);
  const activatorContainer = (0, import_react61.useRef)(null);
  ...
  const setAccessibilityAttributes = (0, import_react61.useCallback)(() => {
  ...
  const portal2 = activatorNode ? /* @__PURE__ */ import_react61.default.createElement(Portal, {
    idPrefix: "popover"
  }, /* @__PURE__ */ import_react61.default.createElement(PopoverOverlay, Object.assign({
    ref: overlayRef,
    id,
  ...
  return /* @__PURE__ */ import_react61.default.createElement(WrapperComponent, {
    ref: activatorContainer
  }, import_react61.Children.only(activator), portal2);
});
...
function Icon({
  ...
  const contentMarkup = {
    function: /* @__PURE__ */ import_react63.default.createElement(SourceComponent, {
      className: styles12.Svg,
      focusable: "false",
      "aria-hidden": "true"
    }),
    placeholder: /* @__PURE__ */ import_react63.default.createElement("div", {
      className: styles12.Placeholder
    }),
    external: /* @__PURE__ */ import_react63.default.createElement("img", {
...
// node_modules/@shopify/polaris/build/esm/utilities/i18n/hooks.js
function useI18n() {
  const i18n = (0, import_react64.useContext)(I18nContext);
  if (!i18n) {
...
var progressIconMap = {
  complete: () => /* @__PURE__ */ import_react66.default.createElement("svg", {
    viewBox: "0 0 20 20"
  ...
  partiallyComplete: () => /* @__PURE__ */ import_react66.default.createElement("svg", {
    viewBox: "0 0 20 20"
  }, /* @__PURE__ */ import_react66.default.createElement("path", {
    fillRule: "evenodd",
  ...
  incomplete: () => /* @__PURE__ */ import_react66.default.createElement("svg", {
    viewBox: "0 0 20 20"
  }, /* @__PURE__ */ import_react66.default.createElement("path", {
    fillRule: "evenodd",
...
function Badge({
  ...
  const withinFilter = (0, import_react66.useContext)(WithinFilterContext);
  ...
  let accessibilityMarkup = Boolean(accessibilityLabel) && /* @__PURE__ */ import_react66.default.createElement(Text, {
    as: "span",
    visuallyHidden: true
  }, accessibilityLabel);
  if (progress && !icon) {
    accessibilityMarkup = polarisSummerEditions2023 ? /* @__PURE__ */ import_react66.default.createElement("span", {
    ...
    }, /* @__PURE__ */ import_react66.default.createElement(Pip, {
      progress,
      status,
  ...
  return /* @__PURE__ */ import_react66.default.createElement("span", {
    className
  }, accessibilityMarkup, icon && /* @__PURE__ */ import_react66.default.createElement("span", {
    className: styles11.Icon
  }, /* @__PURE__ */ import_react66.default.createElement(Icon, {
    source: icon
  })), children && /* @__PURE__ */ import_react66.default.createElement(Text, {
    as: "span",
    variant: "bodySm",
...
function useToggle(initialState) {
  const [value, setState] = (0, import_react67.useState)(initialState);
  return {
    value,
    toggle: (0, import_react67.useCallback)(() => setState((state) => !state), []),
    setTrue: (0, import_react67.useCallback)(() => setState(true), []),
    setFalse: (0, import_react67.useCallback)(() => setState(false), [])
  };
}
...
function useEphemeralPresenceManager() {
  const ephemeralPresenceManager = (0, import_react68.useContext)(EphemeralPresenceManagerContext);
...
// node_modules/@shopify/polaris/build/esm/components/Tooltip/components/TooltipOverlay/TooltipOverlay.js
var tailUpPaths = /* @__PURE__ */ import_react69.default.createElement(import_react69.default.Fragment, null, /* @__PURE__ */ import_react69.default.createElement("path", {
...
var tailDownPaths = /* @__PURE__ */ import_react69.default.createElement(import_react69.default.Fragment, null, /* @__PURE__ */ import_react69.default.createElement("path", {
...
function TooltipOverlay({
  ...
  const i18n = useI18n();
  const markup = active ? /* @__PURE__ */ import_react69.default.createElement(PositionedOverlay, {
    active,
    activator,
    preferredPosition,
    preventInteraction,
  ...
  function renderTooltip(overlayDetails) {
    ...
    return /* @__PURE__ */ import_react69.default.createElement("div", Object.assign({
      style,
      className: containerClassName
    }, layer.props), polarisSummerEditions2023 && /* @__PURE__ */ import_react69.default.createElement("svg", {
      className: styles15.Tail,
      width: "19",
      height: "11",
      fill: "none"
    }, positioning === "above" ? tailDownPaths : tailUpPaths), /* @__PURE__ */ import_react69.default.createElement("div", {
      id,
      role: "tooltip",
...
function Tooltip({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react70.useState)(null);
  const {
    presenceList,
    addPresence,
    removePresence
  ...
  const activatorContainer = (0, import_react70.useRef)(null);
  const mouseEntered = (0, import_react70.useRef)(false);
  const [shouldAnimate, setShouldAnimate] = (0, import_react70.useState)(Boolean(!originalActive));
  const hoverDelayTimeout = (0, import_react70.useRef)(null);
  const hoverOutTimeout = (0, import_react70.useRef)(null);
  ...
  const handleKeyUp = (0, import_react70.useCallback)((event) => {
    if (event.key !== "Escape")
      return;
    handleClose?.();
    handleBlur();
  ...
  const portal2 = activatorNode ? /* @__PURE__ */ import_react70.default.createElement(Portal, {
    idPrefix: "tooltip"
  }, /* @__PURE__ */ import_react70.default.createElement(TooltipOverlay, {
    id,
    preferredPosition,
    activator: activatorNode,
    active,
  ...
  return /* @__PURE__ */ import_react70.default.createElement(WrapperComponent, {
    onFocus: () => {
      handleOpen();
      handleFocus();
    },
...
function useLink() {
  return (0, import_react71.useContext)(LinkContext);
}

// node_modules/@shopify/polaris/build/esm/components/UnstyledLink/UnstyledLink.js
var UnstyledLink = /* @__PURE__ */ (0, import_react72.memo)(/* @__PURE__ */ (0, import_react72.forwardRef)(function UnstyledLink2(props, _ref) {
  const LinkComponent = useLink();
  if (LinkComponent) {
    return /* @__PURE__ */ import_react72.default.createElement(LinkComponent, Object.assign({}, unstyled.props, props, {
      ref: _ref
    }));
  }
  const {
  ...
  return /* @__PURE__ */ import_react72.default.createElement("a", Object.assign({
    target
  }, rest, {
    href: url,
    rel
...
function Item({
  ...
  if (prefix) {
    prefixMarkup = /* @__PURE__ */ import_react73.default.createElement("span", {
  ...
  if (truncate && content) {
    contentText = /* @__PURE__ */ import_react73.default.createElement(TruncateText, null, content);
  } else if (ellipsis) {
    contentText = `${content}\u2026`;
  }
  const contentMarkup = helpText ? /* @__PURE__ */ import_react73.default.createElement(import_react73.default.Fragment, null, /* @__PURE__ */ import_react73.default.createElement(Box, null, contentText), /* @__PURE__ */ import_react73.default.createElement(Text, {
    as: "span",
  ...
  const badgeMarkup = badge && /* @__PURE__ */ import_react73.default.createElement("span", {
    className: styles10.Suffix
  }, /* @__PURE__ */ import_react73.default.createElement(Badge, {
    status: badge.status
  }, badge.content));
  const suffixMarkup = suffix && /* @__PURE__ */ import_react73.default.createElement(Box, null, /* @__PURE__ */ import_react73.default.createElement("span", {
    className: styles10.Suffix
  }, suffix));
  const textMarkup = /* @__PURE__ */ import_react73.default.createElement("span", {
    className: styles10.Text
  }, contentMarkup);
  const contentElement = /* @__PURE__ */ import_react73.default.createElement(HorizontalStack, {
    blockAlign: "center",
    gap: polarisSummerEditions2023 ? "1_5-experimental" : "4",
    wrap: !truncate
  }, prefixMarkup, textMarkup, badgeMarkup, suffixMarkup);
  const contentWrapper = polarisSummerEditions2023 ? /* @__PURE__ */ import_react73.default.createElement(Box, {
    width: "100%"
  }, contentElement) : contentElement;
  const scrollMarkup = active ? /* @__PURE__ */ import_react73.default.createElement(Scrollable.ScrollTo, null) : null;
  const control = url ? /* @__PURE__ */ import_react73.default.createElement(UnstyledLink, {
    id,
    ...
    role
  }, contentWrapper) : /* @__PURE__ */ import_react73.default.createElement("button", {
    id,
    type: "button",
    className,
    disabled,
  ...
  return /* @__PURE__ */ import_react73.default.createElement(import_react73.default.Fragment, null, scrollMarkup, control);
}
var TruncateText = ({
  children
}) => {
  const textRef = (0, import_react73.useRef)(null);
  const [isOverflowing, setIsOverflowing] = (0, import_react73.useState)(false);
  useIsomorphicLayoutEffect(() => {
    if (textRef.current) {
      setIsOverflowing(textRef.current.scrollWidth > textRef.current.offsetWidth);
    }
  }, [children]);
  const text = /* @__PURE__ */ import_react73.default.createElement(Text, {
    as: "span",
    truncate: true
  ...
  return isOverflowing ? /* @__PURE__ */ import_react73.default.createElement(Tooltip, {
...
function Section2({
  ...
  const actionMarkup = section.items.map(({
    ...
    const itemMarkup = /* @__PURE__ */ import_react74.default.createElement(Item, Object.assign({
      content,
      helpText,
      role: actionRole,
      onAction: handleAction(onAction)
    }, item));
    return /* @__PURE__ */ import_react74.default.createElement(Box, {
      as: "li",
      key: `${content}-${index}`,
      role: actionRole === "menuitem" ? "presentation" : void 0
    }, polarisSummerEditions2023 ? /* @__PURE__ */ import_react74.default.createElement(HorizontalStack, {
      wrap: false
    }, itemMarkup) : itemMarkup);
  });
  let titleMarkup = null;
  if (section.title) {
    titleMarkup = typeof section.title === "string" ? /* @__PURE__ */ import_react74.default.createElement(Box, polarisSummerEditions2023 ? {
      paddingBlockStart: "3",
      paddingBlockEnd: "1",
    ...
    }, section.title)) : /* @__PURE__ */ import_react74.default.createElement(Box, {
      padding: "2",
  ...
  const sectionMarkup = /* @__PURE__ */ import_react74.default.createElement(import_react74.default.Fragment, null, titleMarkup, /* @__PURE__ */ import_react74.default.createElement(Box, Object.assign({
  ...
  }), polarisSummerEditions2023 ? /* @__PURE__ */ import_react74.default.createElement(VerticalStack, Object.assign({
    gap: "1",
    as: "ul"
  }, sectionRole && {
    role: sectionRole
  }), actionMarkup) : actionMarkup));
  return hasMultipleSections ? /* @__PURE__ */ import_react74.default.createElement(Box, Object.assign({
    as: "li",
    role: "presentation",
...
function ActionList({
  ...
  const sectionMarkup = finalSections.map((section, index) => {
    return section.items.length > 0 ? /* @__PURE__ */ import_react75.default.createElement(Section2, {
  ...
  const listeners = actionRole === "menuitem" ? /* @__PURE__ */ import_react75.default.createElement(import_react75.default.Fragment, null, /* @__PURE__ */ import_react75.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleFocusNextItem
  }), /* @__PURE__ */ import_react75.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
    handler: handleFocusPreviousItem
  })) : null;
  return /* @__PURE__ */ import_react75.default.createElement(Box, {
...
function UnstyledButton({
  ...
  if (url) {
    buttonMarkup = disabled ? (
      ...
      /* @__PURE__ */ import_react76.default.createElement("a", commonProps, children)
    ) : /* @__PURE__ */ import_react76.default.createElement(UnstyledLink, Object.assign({}, interactiveProps, {
      url,
      external,
      target,
      download
    ...
    buttonMarkup = /* @__PURE__ */ import_react76.default.createElement("button", Object.assign({}, interactiveProps, {
...
function Button({
  ...
  const disclosureMarkup = disclosure ? /* @__PURE__ */ import_react77.default.createElement("span", {
  ...
  const iconSource = isIconSource(icon) ? /* @__PURE__ */ import_react77.default.createElement(Icon, {
    source: loading ? "placeholder" : icon
  }) : icon;
  const iconMarkup = iconSource ? /* @__PURE__ */ import_react77.default.createElement("span", {
    className: classNames(styles5.Icon, loading && styles5.hidden)
  }, iconSource) : null;
  const childMarkup = children ? /* @__PURE__ */ import_react77.default.createElement("span", {
    className: classNames(styles5.Text, removeUnderline && styles5.removeUnderline),
    key: disabled ? "text-disabled" : "text"
  }, children) : null;
  const spinnerSVGMarkup = loading ? /* @__PURE__ */ import_react77.default.createElement("span", {
    className: styles5.Spinner
  }, /* @__PURE__ */ import_react77.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: i18n.translate("Polaris.Button.spinnerAccessibilityLabel")
  })) : null;
  const [disclosureActive, setDisclosureActive] = (0, import_react77.useState)(false);
  const toggleDisclosureActive = (0, import_react77.useCallback)(() => {
  ...
  if (connectedDisclosure) {
    ...
    const connectedDisclosureActivator = /* @__PURE__ */ import_react77.default.createElement("button", {
      type: "button",
    ...
    connectedDisclosureMarkup = /* @__PURE__ */ import_react77.default.createElement(Popover2, {
      active: disclosureActive,
      onClose: toggleDisclosureActive,
      activator: connectedDisclosureActivator,
      preferredAlignment: "right"
    }, /* @__PURE__ */ import_react77.default.createElement(ActionList, {
  ...
  const buttonMarkup = /* @__PURE__ */ import_react77.default.createElement(UnstyledButton, Object.assign({}, commonProps, linkProps, actionProps), /* @__PURE__ */ import_react77.default.createElement("span", {
    className: styles5.Content
  }, spinnerSVGMarkup, iconMarkup, childMarkup, disclosureMarkup));
  return connectedDisclosureMarkup ? /* @__PURE__ */ import_react77.default.createElement("div", {
...
var WithinContentContext = /* @__PURE__ */ (0, import_react78.createContext)(false);
...
function ShadowBevel(props) {
  ...
  const Component2 = as;
  return /* @__PURE__ */ import_react79.default.createElement(Component2, {
...
var Card = ({
  ...
  return /* @__PURE__ */ import_react80.default.createElement(WithinContentContext.Provider, {
    value: true
  }, polarisSummerEditions2023 ? /* @__PURE__ */ import_react80.default.createElement(ShadowBevel, {
    boxShadow: "xs",
    ...
    overflowY: "hidden",
    minHeight: "100%"
  }, children)) : /* @__PURE__ */ import_react80.default.createElement(Box, {
    background,
    padding: finalPadding,
    shadow: "md",
...
function useEventListener(eventName, handler, target, options) {
  ...
  const optionsRef = (0, import_react81.useRef)(options);
  useIsomorphicLayoutEffect(() => {
...
var Spinner2 = /* @__PURE__ */ import_react82.default.forwardRef(function Spinner3({
  onChange,
  onClick,
  onMouseDown,
  onMouseUp,
  ...
  }, /* @__PURE__ */ import_react82.default.createElement(Icon, {
...
function Label({
  ...
  return /* @__PURE__ */ import_react84.default.createElement("div", {
    className
  }, /* @__PURE__ */ import_react84.default.createElement("label", {
    id: labelID(id),
    htmlFor: id,
...
function buttonFrom({
  ...
  return /* @__PURE__ */ import_react85.default.createElement(Button, Object.assign({
    key,
    onClick: onAction
...
function Labelled({
  ...
  const actionMarkup = action ? /* @__PURE__ */ import_react86.default.createElement("div", {
    className: styles18.Action
  }, buttonFrom(action, {
    plain: true
  })) : null;
  const helpTextMarkup = helpText ? /* @__PURE__ */ import_react86.default.createElement("div", {
  ...
  const errorMarkup = error && typeof error !== "boolean" && /* @__PURE__ */ import_react86.default.createElement("div", {
    className: styles18.Error
  }, /* @__PURE__ */ import_react86.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const labelMarkup = label ? /* @__PURE__ */ import_react86.default.createElement("div", {
    className: styles18.LabelWrapper
  }, /* @__PURE__ */ import_react86.default.createElement(Label, Object.assign({
    id,
    requiredIndicator
  }, rest, {
    hidden: false
...
function Connected({
  ...
  const leftConnectionMarkup = left ? /* @__PURE__ */ import_react88.default.createElement(Item2, {
    position: "left"
  }, left) : null;
  const rightConnectionMarkup = right ? /* @__PURE__ */ import_react88.default.createElement(Item2, {
    position: "right"
  }, right) : null;
  return /* @__PURE__ */ import_react88.default.createElement("div", {
    className: styles21.Connected
  }, leftConnectionMarkup, /* @__PURE__ */ import_react88.default.createElement(Item2, {
    position: "primary"
...
function Resizer({
  ...
  const contentNode = (0, import_react89.useRef)(null);
  const minimumLinesNode = (0, import_react89.useRef)(null);
  const animationFrame = (0, import_react89.useRef)();
  const currentHeight = (0, import_react89.useRef)(currentHeightProp);
  ...
  const minimumLinesMarkup = minimumLines ? /* @__PURE__ */ import_react89.default.createElement("div", {
  ...
  const handleHeightCheck = (0, import_react89.useCallback)(() => {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
...
function TextField({
  ...
  const i18n = useI18n();
  const [height, setHeight] = (0, import_react90.useState)(null);
  const [focus, setFocus] = (0, import_react90.useState)(Boolean(focused));
  const isAfterInitial = useIsAfterInitialMount();
  const uniqId = (0, import_react90.useId)();
  const id = idProp ?? uniqId;
  const inputRef = (0, import_react90.useRef)(null);
  const textAreaRef = (0, import_react90.useRef)(null);
  const prefixRef = (0, import_react90.useRef)(null);
  const suffixRef = (0, import_react90.useRef)(null);
  const verticalContentRef = (0, import_react90.useRef)(null);
  const buttonPressTimer = (0, import_react90.useRef)();
  const spinnerRef = (0, import_react90.useRef)(null);
  ...
  const prefixMarkup = prefix ? /* @__PURE__ */ import_react90.default.createElement("div", {
    className: styles17.Prefix,
    id: `${id}-Prefix`,
    ref: prefixRef
  }, prefix) : null;
  const suffixMarkup = suffix ? /* @__PURE__ */ import_react90.default.createElement("div", {
  ...
  if (showCharacterCount) {
    ...
    characterCountMarkup = /* @__PURE__ */ import_react90.default.createElement("div", {
  ...
  const clearButtonMarkup = clearButton && clearButtonVisible ? /* @__PURE__ */ import_react90.default.createElement("button", {
    type: "button",
    ...
    as: "span",
    visuallyHidden: true
  }, i18n.translate("Polaris.Common.clear")), /* @__PURE__ */ import_react90.default.createElement(Icon, {
    source: SvgCircleCancelMinor,
    color: "base"
  })) : null;
  const handleNumberChange = (0, import_react90.useCallback)((steps, stepAmount = normalizedStep) => {
  ...
  const handleButtonRelease = (0, import_react90.useCallback)(() => {
    clearTimeout(buttonPressTimer.current);
  }, []);
  const handleButtonPress = (0, import_react90.useCallback)((onChange2) => {
  ...
  const spinnerMarkup = isNumericType && step !== 0 && !disabled && !readOnly ? /* @__PURE__ */ import_react90.default.createElement(Spinner2, {
    onClick: handleClickChild,
  ...
  const handleExpandingResize = (0, import_react90.useCallback)((height2) => {
    setHeight(height2);
  }, []);
  const resizer = multiline && isAfterInitial ? /* @__PURE__ */ import_react90.default.createElement(Resizer, {
  ...
  const input = /* @__PURE__ */ (0, import_react90.createElement)(multiline ? "textarea" : "input", {
    name,
    id,
    disabled,
    readOnly,
  ...
  const inputWithVerticalContentMarkup = verticalContent ? /* @__PURE__ */ import_react90.default.createElement("div", {
  ...
  const backdropMarkup = /* @__PURE__ */ import_react90.default.createElement("div", {
  ...
  return /* @__PURE__ */ import_react90.default.createElement(Labelled, {
    label,
    id,
    error,
    action: labelAction,
    ...
    disabled,
    readOnly
  }, /* @__PURE__ */ import_react90.default.createElement(Connected, {
    left: connectedLeft,
...
function unstyledButtonFrom({
  ...
  return /* @__PURE__ */ import_react92.default.createElement(UnstyledButton, Object.assign({
    key,
    onClick: onAction
  }, action, overrides), content);
}
...
function ButtonGroup({
  ...
  const contents = elementChildren(children).map((child, index) => /* @__PURE__ */ import_react94.default.createElement(Item3, {
    button: child,
    key: index
  }));
...
function BannerExperimental({
  ...
  const i18n = useI18n();
  const withinContentContainer = (0, import_react95.useContext)(WithinContentContext);
  ...
  const sharedBannerProps = {
    ...
    bannerTitle: title ? /* @__PURE__ */ import_react95.default.createElement(Text, {
      as: "h2",
      variant: "headingSm",
      breakWord: true
    }, title) : null,
    bannerIcon: hideIcon ? null : /* @__PURE__ */ import_react95.default.createElement("span", {
    ...
    actionButtons: action || secondaryAction ? /* @__PURE__ */ import_react95.default.createElement(ButtonGroup, null, action && /* @__PURE__ */ import_react95.default.createElement(Button, Object.assign({
      onClick: action.onAction
    }, action), action.content), secondaryAction && /* @__PURE__ */ import_react95.default.createElement(Button, Object.assign({
      onClick: secondaryAction.onAction
    }, secondaryAction), secondaryAction.content)) : null,
    dismissButton: onDismiss ? /* @__PURE__ */ import_react95.default.createElement(Button, {
      plain: true,
      primary: true,
      icon: /* @__PURE__ */ import_react95.default.createElement("span", {
  ...
  if (withinContentContainer) {
    return /* @__PURE__ */ import_react95.default.createElement(WithinContentContainerBanner, sharedBannerProps, children);
  }
  if (isInlineIconBanner) {
    return /* @__PURE__ */ import_react95.default.createElement(InlineIconBanner, sharedBannerProps, children);
  }
  return /* @__PURE__ */ import_react95.default.createElement(DefaultBanner, sharedBannerProps, children);
}
function DefaultBanner({
  ...
  return /* @__PURE__ */ import_react95.default.createElement(Box, {
    width: "100%"
  }, /* @__PURE__ */ import_react95.default.createElement(VerticalStack, {
    align: "space-between"
    ...
    padding: "3"
  }, /* @__PURE__ */ import_react95.default.createElement(HorizontalStack, {
    align: "space-between",
    blockAlign: "center",
    gap: "2",
    wrap: false
    ...
    gap: "1",
    wrap: false
  }, bannerIcon, bannerTitle), dismissButton)), hasContent && /* @__PURE__ */ import_react95.default.createElement(Box, {
    padding: {
      xs: "3",
      md: "4"
    },
    ...
    gap: "2"
  }, /* @__PURE__ */ import_react95.default.createElement("div", null, children), actionButtons))));
}
function InlineIconBanner({
  ...
  const [blockAlign, setBlockAlign] = (0, import_react95.useState)("center");
  const contentNode = (0, import_react95.useRef)(null);
  const iconNode = (0, import_react95.useRef)(null);
  const handleResize = (0, import_react95.useCallback)(() => {
  ...
  (0, import_react95.useEffect)(() => handleResize(), [handleResize]);
  ...
  return /* @__PURE__ */ import_react95.default.createElement(Box, {
    ...
    borderRadius: "2",
    padding: "1"
  }, bannerIcon)), /* @__PURE__ */ import_react95.default.createElement(Box, {
    ref: contentNode,
    width: "100%"
  }, /* @__PURE__ */ import_react95.default.createElement(VerticalStack, {
    gap: "2"
  }, /* @__PURE__ */ import_react95.default.createElement("div", null, children), actionButtons)))), dismissButton));
}
function WithinContentContainerBanner({
  ...
  return /* @__PURE__ */ import_react95.default.createElement(Box, {
    ...
    gap: "05"
  }, bannerTitle, /* @__PURE__ */ import_react95.default.createElement("div", null, children)), actionButtons))), dismissButton));
}
...
var Banner = /* @__PURE__ */ (0, import_react96.forwardRef)(function Banner2(props, bannerRef) {
  ...
  if (title) {
    headingMarkup = /* @__PURE__ */ import_react96.default.createElement(Text, {
      as: "h2",
      variant: "headingMd",
      breakWord: true
    }, title);
  }
  const spinnerMarkup = action?.loading ? /* @__PURE__ */ import_react96.default.createElement("button", {
    disabled: true,
    "aria-busy": true,
  ...
  }, /* @__PURE__ */ import_react96.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: i18n.translate("Polaris.Button.spinnerAccessibilityLabel")
  })), action.content) : null;
  const primaryActionMarkup = action ? /* @__PURE__ */ import_react96.default.createElement(Box, {
    paddingInlineEnd: "2"
  }, action.loading ? spinnerMarkup : unstyledButtonFrom(action, {
    className: `${styles22.Button} ${styles22.PrimaryAction}`
  })) : null;
  const secondaryActionMarkup = secondaryAction ? /* @__PURE__ */ import_react96.default.createElement(SecondaryActionFrom, {
    action: secondaryAction
  }) : null;
  const actionMarkup = action || secondaryAction ? /* @__PURE__ */ import_react96.default.createElement(Box, {
    paddingBlockStart: withinContentContainer ? "3" : "4",
    paddingBlockEnd: withinContentContainer ? "1" : void 0
  }, /* @__PURE__ */ import_react96.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup)) : null;
  let contentMarkup = null;
  if (children || actionMarkup) {
    contentMarkup = /* @__PURE__ */ import_react96.default.createElement(Box, {
      paddingBlockStart: "05",
      paddingBlockEnd: "05"
    }, children, actionMarkup);
  }
  const dismissButton = onDismiss && /* @__PURE__ */ import_react96.default.createElement("div", {
  ...
  return /* @__PURE__ */ import_react96.default.createElement(BannerContext.Provider, {
    ...
    onKeyUp: handleKeyUp,
    onBlur: handleBlur
  }, polarisSummerEditions2023 ? /* @__PURE__ */ import_react96.default.createElement(BannerExperimental, props) : /* @__PURE__ */ import_react96.default.createElement(import_react96.default.Fragment, null, dismissButton, hideIcon ? null : /* @__PURE__ */ import_react96.default.createElement(Box, {
    paddingInlineEnd: "4"
...
function SecondaryActionFrom({
  ...
  if (action.url) {
    return /* @__PURE__ */ import_react96.default.createElement(UnstyledLink, {
  ...
  return /* @__PURE__ */ import_react96.default.createElement(UnstyledButton, {
    className: styles22.SecondaryAction,
    onClick: action.onAction
  }, /* @__PURE__ */ import_react96.default.createElement("span", {
    className: styles22.Text
...
function useBannerFocus(bannerRef) {
  ...
  const [shouldShowFocus, setShouldShowFocus] = (0, import_react96.useState)(false);
  (0, import_react96.useImperativeHandle)(bannerRef, () => ({
    focus: () => {
...
var Divider = ({
  ...
  return /* @__PURE__ */ import_react97.default.createElement("hr", {
...
function Group({
  ...
  const itemsMarkup = import_react99.Children.map(children, (child) => wrapWithComponent(child, Item4, {}));
...
function AnnotatedSection({
  ...
  const descriptionMarkup = (
    // eslint-disable-next-line no-nested-ternary
    typeof description === "string" ? polarisSummerEditions2023 ? /* @__PURE__ */ import_react102.default.createElement(Text, {
      as: "p",
      variant: "bodyMd"
    }, description) : /* @__PURE__ */ import_react102.default.createElement("p", null, description) : description
  );
  ...
  }, /* @__PURE__ */ import_react102.default.createElement(TextContainer, {
    spacing: polarisSummerEditions2023 ? "tight" : void 0
  }, /* @__PURE__ */ import_react102.default.createElement(Text, {
    id,
    variant: "headingMd",
    as: "h2"
  }, title), descriptionMarkup && /* @__PURE__ */ import_react102.default.createElement(Box, {
    color: "text-subdued"
  }, descriptionMarkup))), /* @__PURE__ */ import_react102.default.createElement("div", {
...
var Layout = function Layout2({
  ...
  const content = sectioned ? /* @__PURE__ */ import_react104.default.createElement(Section3, null, children) : children;
...
var List = function List2({
  ...
  return /* @__PURE__ */ import_react106.default.createElement(ListElement, {
    className
  }, children);
};
List.Item = Item5;
...
function isInterface(x) {
  return !/* @__PURE__ */ (0, import_react107.isValidElement)(x) && x !== void 0;
}
...
function Breadcrumbs({
  ...
  const contentMarkup = /* @__PURE__ */ import_react109.default.createElement(import_react109.default.Fragment, null, /* @__PURE__ */ import_react109.default.createElement("span", {
  ...
  const breadcrumbMarkup = "url" in backAction ? /* @__PURE__ */ import_react109.default.createElement(UnstyledLink, {
    key: content,
    url: backAction.url,
    className: styles32.Breadcrumb,
    onMouseUp: handleMouseUpByBlurring,
    "aria-label": backAction.accessibilityLabel
  }, contentMarkup) : /* @__PURE__ */ import_react109.default.createElement("button", {
    key: content,
    className: styles32.Breadcrumb,
  ...
  const summerEditionsBreadcrumbMarkup = /* @__PURE__ */ import_react109.default.createElement(Button, {
    key: content,
  ...
  return /* @__PURE__ */ import_react109.default.createElement("nav", {
    role: "navigation"
...
function RollupActions({
  ...
  const activatorMarkup = /* @__PURE__ */ import_react112.default.createElement("div", {
  ...
  return /* @__PURE__ */ import_react112.default.createElement(Popover2, {
    active: rollupOpen,
...
function SecondaryAction({
  ...
  const secondaryActionsRef = (0, import_react113.useRef)(null);
  (0, import_react113.useEffect)(() => {
    if (!getOffsetWidth || !secondaryActionsRef.current)
      return;
    getOffsetWidth(secondaryActionsRef.current?.offsetWidth);
  }, [getOffsetWidth]);
  const buttonMarkup = /* @__PURE__ */ import_react113.default.createElement(Button, Object.assign({
    onClick: onAction
  }, rest), children);
  const actionMarkup = helpText ? /* @__PURE__ */ import_react113.default.createElement(Tooltip, {
    content: helpText
...
function MenuGroup({
  ...
  const handleOpen = (0, import_react114.useCallback)(() => {
    onOpen(title);
  }, [onOpen, title]);
  const handleClick = (0, import_react114.useCallback)(() => {
    if (onClick) {
      onClick(handleOpen);
    } else {
      handleOpen();
  ...
  const handleOffsetWidth = (0, import_react114.useCallback)((width) => {
    if (!getOffsetWidth)
      return;
    getOffsetWidth(width);
  }, [getOffsetWidth]);
  const popoverActivator = /* @__PURE__ */ import_react114.default.createElement(SecondaryAction, {
    disclosure: true,
    disabled,
    icon,
    accessibilityLabel,
  ...
  }), details && /* @__PURE__ */ import_react114.default.createElement("div", {
...
function Actions({
  ...
  const i18n = useI18n();
  const actionsLayoutRef = (0, import_react115.useRef)(null);
  const menuGroupWidthRef = (0, import_react115.useRef)(0);
  const availableWidthRef = (0, import_react115.useRef)(0);
  const actionsAndGroupsLengthRef = (0, import_react115.useRef)(0);
  const timesMeasured = (0, import_react115.useRef)(0);
  const actionWidthsRef = (0, import_react115.useRef)([]);
  const rollupActiveRef = (0, import_react115.useRef)(null);
  const {
    polarisSummerEditions2023
  } = useFeatures();
  const [activeMenuGroup, setActiveMenuGroup] = (0, import_react115.useState)(void 0);
  const [measuredActions, setMeasuredActions] = (0, import_react115.useState)({
    showable: [],
    rolledUp: []
  });
  ...
  const handleActionsOffsetWidth = (0, import_react115.useCallback)((width) => {
    actionWidthsRef.current = [...actionWidthsRef.current, width];
  }, []);
  const handleMenuGroupToggle = (0, import_react115.useCallback)((group) => setActiveMenuGroup(activeMenuGroup ? void 0 : group), [activeMenuGroup]);
  const handleMenuGroupClose = (0, import_react115.useCallback)(() => setActiveMenuGroup(void 0), []);
  const updateActions = (0, import_react115.useCallback)(() => {
  ...
  const measureActions = (0, import_react115.useCallback)(() => {
  ...
  const handleResize = (0, import_react115.useMemo)(() => debounce(() => {
  ...
  const actionsMarkup = actions.map((action) => {
    ...
    return /* @__PURE__ */ import_react115.default.createElement(SecondaryAction, Object.assign({
      key: content,
      onClick: onAction
    }, rest, {
  ...
  const rollUppableActionsMarkup = measuredActions.showable.length > 0 ? measuredActions.showable.map((action) => action.content && /* @__PURE__ */ import_react115.default.createElement(SecondaryAction, Object.assign({
    key: action.content
  }, action, {
    getOffsetWidth: handleActionsOffsetWidth
  }), action.content)) : null;
  ...
  const groupsMarkup = filteredGroups.map((group) => {
    ...
    if (!isDefaultGroup && !isLastMenuGroup) {
      return /* @__PURE__ */ import_react115.default.createElement(MenuGroup, Object.assign({
        key: title,
        title,
  ...
  const groupedActionsMarkup = /* @__PURE__ */ import_react115.default.createElement(ButtonGroup, {
...
function ActionMenu({
  ...
  }, rollup ? /* @__PURE__ */ import_react116.default.createElement(RollupActions, {
    accessibilityLabel: rollupActionsLabel,
    items: actions,
    sections: rollupSections
  }) : /* @__PURE__ */ import_react116.default.createElement(Actions, {
    actions,
    groups,
    onActionRollup
  }));
...
function useMediaQuery() {
  const mediaQuery = (0, import_react117.useContext)(MediaQueryContext);
  if (!mediaQuery) {
...
function Header({
  ...
  const breadcrumbMarkup = backAction ? /* @__PURE__ */ import_react118.default.createElement("div", {
    className: styles31.BreadcrumbWrapper
  }, /* @__PURE__ */ import_react118.default.createElement(Box, {
    maxWidth: "100%",
    paddingInlineEnd: polarisSummerEditions2023 ? "1" : "4",
    printHidden: true
  }, /* @__PURE__ */ import_react118.default.createElement(Breadcrumbs, {
    backAction
  }))) : null;
  const paginationMarkup = pagination && !isNavigationCollapsed ? /* @__PURE__ */ import_react118.default.createElement("div", {
    className: styles31.PaginationWrapper
  }, /* @__PURE__ */ import_react118.default.createElement(Box, {
    printHidden: true
  }, /* @__PURE__ */ import_react118.default.createElement(Pagination, pagination))) : null;
  const additionalNavigationMarkup = additionalNavigation ? /* @__PURE__ */ import_react118.default.createElement(HorizontalStack, {
    gap: "4",
    align: "end"
  }, /* @__PURE__ */ import_react118.default.createElement(Box, {
    printHidden: true
  }, additionalNavigation)) : null;
  const pageTitleMarkup = /* @__PURE__ */ import_react118.default.createElement("div", {
    className: styles31.TitleWrapper
  }, /* @__PURE__ */ import_react118.default.createElement(Title, {
    title,
    subtitle,
    titleMetadata,
    compactTitle
  }));
  const primaryActionMarkup = primaryAction ? /* @__PURE__ */ import_react118.default.createElement(PrimaryActionMarkup, {
    primaryAction
  }) : null;
  let actionMenuMarkup = null;
  if (isInterface(secondaryActions) && (secondaryActions.length > 0 || hasGroupsWithActions(actionGroups))) {
    actionMenuMarkup = /* @__PURE__ */ import_react118.default.createElement(ActionMenu, {
    ...
    actionMenuMarkup = /* @__PURE__ */ import_react118.default.createElement(import_react118.default.Fragment, null, secondaryActions);
  }
  const navigationMarkup = breadcrumbMarkup || paginationMarkup || additionalNavigationMarkup ? /* @__PURE__ */ import_react118.default.createElement(Box, {
    printHidden: true,
    paddingBlockEnd: "1",
    paddingInlineEnd: actionMenuMarkup && isNavigationCollapsed ? "10" : void 0
  }, /* @__PURE__ */ import_react118.default.createElement(HorizontalStack, {
    gap: "4",
    align: "space-between",
    blockAlign: "center"
  }, breadcrumbMarkup, additionalNavigationMarkup, paginationMarkup)) : null;
  const additionalMetadataMarkup = additionalMetadata ? /* @__PURE__ */ import_react118.default.createElement("div", {
  ...
  }, /* @__PURE__ */ import_react118.default.createElement(ConditionalRender, {
    condition: [slot1, slot2, slot3, slot4].some(notNull)
  }, /* @__PURE__ */ import_react118.default.createElement("div", {
    className: styles31.Row
  }, slot1, slot2, /* @__PURE__ */ import_react118.default.createElement(ConditionalRender, {
    condition: [slot3, slot4].some(notNull)
  }, /* @__PURE__ */ import_react118.default.createElement("div", {
    className: styles31.RightAlign
  }, /* @__PURE__ */ import_react118.default.createElement(ConditionalWrapper, {
    condition: [slot3, slot4].every(notNull),
    wrapper: (children) => /* @__PURE__ */ import_react118.default.createElement("div", {
      className: styles31.Actions
    }, children)
  }, slot3, slot4))))), /* @__PURE__ */ import_react118.default.createElement(ConditionalRender, {
    condition: [slot5, slot6].some(notNull)
  }, /* @__PURE__ */ import_react118.default.createElement("div", {
    className: styles31.Row
  }, /* @__PURE__ */ import_react118.default.createElement(HorizontalStack, {
    gap: "4"
  }, slot5), /* @__PURE__ */ import_react118.default.createElement(ConditionalRender, {
...
function PrimaryActionMarkup({
  ...
  if (isInterface(primaryAction)) {
    ...
    actionMarkup = helpText ? /* @__PURE__ */ import_react118.default.createElement(Tooltip, {
      content: helpText
    }, content) : content;
  } else {
  ...
  const layouts = {
    ...
    desktopDefault: {
      slots: {
        slot1: breadcrumbMarkup,
        slot2: pageTitleMarkup,
        slot3: /* @__PURE__ */ import_react118.default.createElement(import_react118.default.Fragment, null, actionMenuMarkup, primaryActionMarkup),
...
function Page({
  ...
  const headerMarkup = hasHeaderContent ? /* @__PURE__ */ import_react119.default.createElement(Header, rest) : null;
  return /* @__PURE__ */ import_react119.default.createElement("div", {
    className: pageClassName
  }, headerMarkup, /* @__PURE__ */ import_react119.default.createElement("div", {
    className: contentClassName
  }, children));
}
...
//# sourceMappingURL=/build/_shared/chunk-LJG4VVSV.js.map
